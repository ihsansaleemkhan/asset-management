...
<link rel="icon" type="png" href="images/holoteq-logo.png"/>
...
<!-- Local Styles -->
 <link rel="stylesheet" type="text/css" href="${context}/css/main-nav.css">
 <link rel="stylesheet" type="text/css" href="${context}/css/main-style.css">
