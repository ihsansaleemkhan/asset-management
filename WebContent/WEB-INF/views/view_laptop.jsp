	...
	<div class="content-wrapper">
		<div class="record-container">
		  <div class="container-record" style="border-radius: 18px;">
				...
				<div class="row">
				   <form class="filter-form" id="laptopsFilterForm">
					  <div class="row">
					        <div class="col-lg-10">
		              ...
		              <input type="hidden" name="asset_type" value="10" />
					  <input type="hidden" name="action" value="fetch-laptops-list" />
				   </form>
				   
				   <div class="col-md-12" style="padding: 10px 48px;">
						<table id="laptopsTable" class="table table-striped table-bordered" style="width: 100%; text-align: center">
							<thead>
...
$(document).ready(function(){
  ...
  populateLaptopsListTable();
  populateLaptopsFilterTags();
  
});

$("#laptopsFilterForm").submit( function(event) {
...
$("#laptopsFilterForm").on("click", ".filter-tag-remove", function() {
	let inputName = $(this).parents(".filter-tag").data("name");
	$(this).parents(".filter-tag").remove();
	$("#laptopsFilterForm select[name='" + inputName + "'] option:first-child").prop("selected", true);
	populateLaptopsListTable();
 });

function populateLaptopsFilterTags() {
	let tags = "";
    $.each($("#laptopsFilterForm select"), function(key, value) {
...
function populateLaptopsListTable() {
	
	let table = $('#laptopsTable').dataTable({
		destroy : true,
		scrollX : true,
		responsive : true,
		"searching" : false,
...
function getlaptopsListParam() {
	 let formData = $("#laptopsFilterForm").serializeArray();
	 let jsonFormData = {};
