	...
	<div class="content-wrapper">
		<div class="record-container">
		  <div class="container-record" style="border-radius: 18px;">
				...
				<div class="row">
				   <form class="filter-form" id="upsFilterForm">
					  <div class="row">
					        <div class="col-lg-10">
		              ...
		              <input type="hidden" name="asset_type" value="16" />
					  <input type="hidden" name="action" value="fetch-ups-list" />
				   </form>
				   
				   <div class="col-md-12" style="padding: 10px 48px;">
						<table id="upsTable" class="table table-striped table-bordered" style="width: 100%; text-align: center">
							<thead>
...
$(document).ready(function(){
  ...
  populateUPSListTable();
  populateUPSListFilterTags();
  
});

$("#upsFilterForm").submit( function(event) {
...
$("#upsFilterForm").on("click", ".filter-tag-remove", function() {
...
function populateUPSListFilterTags() {
	let tags = "";
    $.each($("#upsFilterForm select"), function(key, value) {
...
function populateUPSListTable() {
	
	let table = $('#upsTable').dataTable({
		destroy : true,
		scrollX : true,
		responsive : true,
		"searching" : false,
...
function getUPSListParam() {
	 let formData = $("#upsFilterForm").serializeArray();
	 let jsonFormData = {};
