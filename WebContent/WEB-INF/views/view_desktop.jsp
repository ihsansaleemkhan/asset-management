	...
	<div class="content-wrapper">
		<div class="record-container">
		  <div class="container-record" style="border-radius: 18px;">
				...
				<div class="row">
				   <form class="filter-form" id="desktopFilterForm">
					  <div class="row">
					        <div class="col-lg-10">
		               ...
		               <input type="hidden" name="asset_type" value="24" />
					  <input type="hidden" name="action" value="fetch-desktop-list" />
				   </form>
				   
				   <div class="col-md-12" style="padding: 10px 48px;">
						<table id="desktopTable" class="table table-striped table-bordered" style="width: 100%; text-align: center">
							<thead>
...
$(document).ready(function(){
  ...
  populateDesktopListTable();
  populateDesktoListFilterTags();
  
});

$("#desktopFilterForm").submit( function(event) {
...
$("#desktopFilterForm").on("click", ".filter-tag-remove", function() {
...
function populateDesktoListFilterTags() {
	let tags = "";
    $.each($("#desktopFilterForm select"), function(key, value) {
...
function populateDesktopListTable() {
	
	let table = $('#desktopTable').dataTable({
		destroy : true,
		scrollX : true,
		responsive : true,
		"searching" : false,
...
function getDesktopListParam() {
	 let formData = $("#desktopFilterForm").serializeArray();
	 let jsonFormData = {};
